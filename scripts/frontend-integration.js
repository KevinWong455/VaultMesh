 ...
 * This file demonstrates how to integrate Vaultmesh with a web frontend
 */

// For React/Vue/Angular applications
export class VaultmeshClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VaultmeshClient(provider, contractAddress);
